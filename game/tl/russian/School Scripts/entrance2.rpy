...
screen entrance2_screen(g=entrance2_girls):
    add "entrance2_bg"
    for i in g.clicks:
        button:
            focus_mask True pos i.pos
            add i.image
            at entrance2_button_animation
            action i.action
...
transform entrance2_button_animation:
    on idle:
        ease .1 yoffset 0 additive 0
    on hover:
        ease .1 yoffset -10 additive .2

default entrance2_bg = class_click("entrance2_bg", "entrance2_bg", None, (0, 0))
default entrance2_straight = class_click("Straight", "entrance2_straight", Jump("entrance2_straight"), (1025, 620))


default entrance2_girls = class_handler(
    [
        entrance2_bg,
        entrance2_straight, 
    ]
...
label entrance2_example:
    scene entrance2_bg
    call screen entrance2_screen

label entrance2_straight:
    jump gate_example
return
