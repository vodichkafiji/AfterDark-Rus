...
screen secondhallway3_screen(g=secondhallway3_girls):
    add "secondhallway3_bg"
    for i in g.clicks:
        button:
            focus_mask True pos i.pos
            add i.image
            at secondhallway3_button_animation
            action i.action
    ...
    imagebutton:
        idle "noon_idle.png"
        hover "noon_idle.png"
        action Jump("secondhallway3_example")
        xpos 0.999999
        ypos 0.23
        xanchor 1.0
        yanchor 1.0
...
transform secondhallway3_button_animation:
    on idle:
        ease .1 yoffset 0 additive 0
    on hover:
        ease .1 yoffset -10 additive .2

default secondhallway3_bg = class_click("secondhallway3_bg", "secondhallway3_bg", None, (0, 0))
default secondhallway3_right = class_click("Right", "secondhallway3_right", Jump("secondhallway3_right"), (2870, 0))



default secondhallway3_girls = class_handler(
    [
        secondhallway3_bg,
        secondhallway3_right, 
    ]
    )

label secondhallway3_example:
    scene secondhallway3_bg
    call screen secondhallway3_screen

label secondhallway3_right:
    if storydream1 == 1 and storydream2 == 0:
        jump secondhallway4_example
    elif intro_grace == 0:
        jump grace_intro
    elif Grace.affection >= 7 and graceinvest == 1 and graceinterrogate == 0:
        jump grace_interrogate
    else:
