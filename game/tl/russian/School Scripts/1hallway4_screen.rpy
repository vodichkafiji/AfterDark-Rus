...
screen firsthallway4_screen(g=firsthallway4_girls):
    add "firsthallway4_bg"
    for i in g.clicks:
        button:
            focus_mask True pos i.pos
            add i.image
            at firsthallway4_button_animation
            action i.action
    ...
    imagebutton:
        idle "noon_idle.png"
        hover "noon_idle.png"
        action Jump("firsthallway4_example")
        xpos 0.999999
        ypos 0.23
        xanchor 1.0
        yanchor 1.0
...
transform firsthallway4_button_animation:
    on idle:
        ease .1 yoffset 0 additive 0
    on hover:
        ease .1 yoffset -10 additive .2

default firsthallway4_bg = class_click("firsthallway4_bg", "firsthallway4_bg", None, (0, 0))
default firsthallway4_hall = class_click("Stairs", "firsthallway4_hall", Jump("firsthallway4_hall"), (950, 0))



default firsthallway4_girls = class_handler(
    [
        firsthallway4_bg,
        firsthallway4_hall,
    ]
...
label firsthallway4_example:
    scene firsthallway4_bg
    call screen firsthallway4_screen

label firsthallway4_hall:
    jump firsthallway5_example
return
