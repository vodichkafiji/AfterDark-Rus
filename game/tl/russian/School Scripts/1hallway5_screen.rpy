...
screen firsthallway5_screen(g=firsthallway5_girls):
    add "firsthallway5_bg"
    for i in g.clicks:
        button:
...
default firsthallway5_bg = class_click("firsthallway5_bg", "firsthallway5_bg", None, (0, 0))
default firsthallway5_door = class_click("Stairs", "firsthallway5_door", Jump("firsthallway5_door"), (2060, 165))



default firsthallway5_girls = class_handler(
    [
        firsthallway5_bg,
        firsthallway5_door, 
    ]
...
label firsthallway5_example:
    scene firsthallway5_bg
    call screen firsthallway5_screen

label firsthallway5_door:
