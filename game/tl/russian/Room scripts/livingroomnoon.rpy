...
screen livingroomnoon_screen(g=livingroomnoon_girls):
    add "livingroomnoon_bg"
    for i in g.clicks:
        button:
            focus_mask True pos i.pos
            add i.image
            at livingroomnoon_button_animation
            action i.action
    imagebutton:
...
transform livingroomnoon_button_animation:
    on idle:
        ease .1 yoffset 0 additive 0
    on hover:
        ease .1 yoffset -10 additive .2

default livingroomnoon_bg = class_click("livingroomnoon_bg", "livingroomnoon_bg", None, (0, 0))


default livingroomnoon_girls = class_handler(
    [
        livingroomnoon_bg
...
label livingroomnoon_example:
    call screen livingroomnoon_screen
return