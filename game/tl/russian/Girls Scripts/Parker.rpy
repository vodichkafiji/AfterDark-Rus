label parker_intro:
    ...
    "Ты успеваешь сделать всего два шага из класса, прежде чем голос Отэм разрезает тишину."
    ...
    mc "ЭЙ, ТВАРЬ! Я ЗНАЮ, ЧТО ТЫ МЕНЯ СЛЫШИШЬ!"
    scene parkerintro (13) with hpunch
    ...
    "Ты возвращаешься домой, где у дверей тебя встречает Отэм."
...
label parkercityintro:
    ...
    with dissolve
    mc "(Честно говоря, я даже не злюсь — я просто поражен способностью Отэм заставить меня чувствовать вину и подтолкнуть к черновой работе.)"
