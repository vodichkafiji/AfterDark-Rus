...
label warehouse_door_scene:
    ...
    k "Может, нам стоит сосредоточиться на том, чтобы стать сильнее и узнать больше об этих типах со Зрачком."
    ...
    "Ты собираешь волю в кулак. Запугивание на этих типов не сработает."
...
label fight_final_win:
    ...
    mc "Отэм, наверное, уже с ума сходит от волнения."
