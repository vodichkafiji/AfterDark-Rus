...
label actualintro:
    ...
    label scene_4:
        ...
        a "Не переживай так, чувак. Я так и не собралась упомянуть твою винтажную коллекцию порнухи."
        ...
        q "Слушай, чувак, вижу, что ты никогда не был с женщиной, но мне ни одна девчонка не отказывает."
        ...
        mc "Просто оставь её в покое, чувак."
    ...
    label scene_7:
        ...
        pe "Говорю тебе, чувак, Бэтмен с временем на подготовку побеждает всех."
        ...
        l "Эй, чувак! Ты как? Выглядишь так, будто призрака увидел."
        ...
        l "Ага, чувак, ты сегодня прогулял урок."
        ...
        mc "{i}Эй, придурок, молоко просрочилось. Сходишь за новым?{/i}"
        ...
        mc "{i}Чувак! Выйди отсюда, я переодеваюсь!{/i}"
    ...
    label Chapter1Scene1:
        ...
        pe "Конечно поможем, чувак, мы же друзья."
        ...
        pe "Чувак!! Так нельзя говорить! Это же Харриет Беснос!"
        mc "...."
        ...
        l "Только тебе показалось, чувак."
        ...
        mc "Блин."
        l "Ой, да не грусти, чувак! Ты хотя бы с ней поговорил!"
        ...
        menu GirlsClassroom:
            ...
            "Две девушки в центре" if option7 == False:
                ...
                pe "Она просто странная, чувак, она сидит на этих форумах 4chan и вечно говорит какую-то дичь не по делу."
